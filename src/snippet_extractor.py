...
from src.embedder import embed_with_context
...
class ContextualEmbeddingEngine:
    ...
    @staticmethod
    def create_contextual_embedding(sentence: str, context: str, persona: str, job_to_be_done: str) -> np.ndarray:
...
def extract_top_snippets(
    ...
    enhanced_snippets = extract_enhanced_snippets(
        section_content, header, persona, job_to_be_done, top_k=top_k, lambda_param=lambda_param
    )
